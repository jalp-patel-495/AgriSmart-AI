...
export const CANONICAL_CLASSES = [
  ...
  { id: 3, name: 'Bell_Pepper_Bacterial_Spot', crop: 'Bell Pepper', disease: 'Bacterial Spot', status: 'Diseased', pathogen: 'Xanthomonas campestris pv. vesicatoria (Bacteria)' },
  { id: 4, name: 'Bell_Pepper_Healthy', crop: 'Bell Pepper', disease: 'Healthy', status: 'Healthy', pathogen: null },
  { id: 5, name: 'Corn___Common_rust', crop: 'Corn', disease: 'Common Rust', status: 'Diseased', pathogen: 'Puccinia sorghi (Fungus)' },
  { id: 6, name: 'Corn___healthy', crop: 'Corn', disease: 'Healthy', status: 'Healthy', pathogen: null },
  { id: 7, name: 'Corn___Northern_Leaf_Blight', crop: 'Corn', disease: 'Northern Leaf Blight', status: 'Diseased', pathogen: 'Exserohilum turcicum (Fungus)' },
  { id: 8, name: 'Grape_Black_Rot', crop: 'Grape', disease: 'Black Rot', status: 'Diseased', pathogen: 'Guignardia bidwellii (Fungus)' },
  { id: 9, name: 'Grape_Healthy', crop: 'Grape', disease: 'Healthy', status: 'Healthy', pathogen: null },
  { id: 10, name: 'Peach_Bacterial_Spot', crop: 'Peach', disease: 'Bacterial Spot', status: 'Diseased', pathogen: 'Xanthomonas arboricola pv. pruni (Bacteria)' },
  { id: 11, name: 'Peach_Healthy', crop: 'Peach', disease: 'Healthy', status: 'Healthy', pathogen: null },
  { id: 12, name: 'Potato___Early_blight', crop: 'Potato', disease: 'Early Blight', status: 'Diseased', pathogen: 'Alternaria solani (Fungus)' },
  { id: 13, name: 'Potato___healthy', crop: 'Potato', disease: 'Healthy', status: 'Healthy', pathogen: null },
  { id: 14, name: 'Potato___Late_blight', crop: 'Potato', disease: 'Late Blight', status: 'Diseased', pathogen: 'Phytophthora infestans (Oomycete)' },
  { id: 15, name: 'Tomato___Bacterial_spot', crop: 'Tomato', disease: 'Bacterial Spot', status: 'Diseased', pathogen: 'Xanthomonas perforans (Bacteria)' },
  { id: 16, name: 'Tomato___Early_blight', crop: 'Tomato', disease: 'Early Blight', status: 'Diseased', pathogen: 'Alternaria solani (Fungus)' },
  { id: 17, name: 'Tomato___healthy', crop: 'Tomato', disease: 'Healthy', status: 'Healthy', pathogen: null },
  { id: 18, name: 'Tomato___Late_blight', crop: 'Tomato', disease: 'Late Blight', status: 'Diseased', pathogen: 'Phytophthora infestans (Oomycete)' }
];
